  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content="hydroponics, growing solutions, horticulture, sustainable farming"
        />
          ...
          <div className="container">
            ...
            >
              ...
              <p className="text-xl text-hydro-onyx/80 mb-8 max-w-3xl mx-auto">
                At Hydro Works, we source high-performance horticultural
                products and partner with industry experts to provide growers
                with the tools, knowledge, and support for consistent,
                successful harvests.
              </p>
                    ...
                    >
                      ...
                      >
                        <div className="flex items-center mb-4">
                          ...
                          <div>
                            <h2 className="text-2xl font-bold text-hydro-onyx">
                              {solution.title}
                            </h2>
                            <p className="text-hydro-green font-medium">
                              {solution.shortDescription}
                            </p>
                          </div>
                        </div>

                        <p className="text-hydro-onyx/80 mb-6">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {solution.applications.map((app, i) => (
                              <Badge
                                key={i}
                                variant="secondary"
                                className="bg-hydro-mint/30 text-hydro-onyx"
                              >
                                {app}
                              </Badge>
                            ))}
          ...
          <div className="container text-center">
            ...
            >
              ...
              <p className="text-hydro-white/80 mb-8 max-w-2xl mx-auto">
                Our team will help you design a growing system that matches your
                goals, budget, and space. Let's build something sustainable
                together.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
