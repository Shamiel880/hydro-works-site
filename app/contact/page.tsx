...
const officeLocations = [
  {
    ...
    image:
      "/images/cape-town-map.png?height=200&width=300&text=Cape+Town+Office",
  },
];
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-lg text-hydro-onyx/70 max-w-2xl mx-auto">
                We're available through multiple channels to provide you with
                ...
                >
                  <Card className="h-full border border-hydro-green/20 hover:border-hydro-green/40 transition-all duration-300 hover:shadow-lg cursor-pointer group rounded-lg">
                    <CardContent className="p-6 text-center">
                      ...
                      <p className="text-sm text-hydro-onyx/70 mb-3">
                        {method.description}
                      </p>
                      <p className="font-medium text-hydro-green mb-2">
                        {method.contact}
                      </p>
                      <p className="text-xs text-hydro-onyx/60 mb-4">
                        {method.availability}
                      </p>
                      <Button
                        type="button"
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              >
                <Card className="border-hydro-green/20">
                  <CardHeader>
                    <CardTitle className="text-2xl text-hydro-onyx">
                      Send Us a Message
                    </CardTitle>
              ...
              >
                ...
                <Card className="border-hydro-green/20">
                  <CardHeader>
                    <CardTitle className="text-xl text-hydro-onyx">
                      Quick Contact
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    {/* Phone */}
                    <div
                      className="flex items-center cursor-pointer hover:bg-hydro-green/5 rounded px-2 py-1 transition"
                      onClick={() =>
                        (window.location.href = "tel:+27793215597")
                      }
                    >
                      ...
                      <div>
                        <p className="font-medium text-hydro-onyx">
                          +27 79 321 5597
                        </p>
                  ...
                  <CardContent>
                    <div className="space-y-6">
                      {officeLocations.map((office, index) => (
                        <div
                          key={index}
                          className="border-b border-hydro-green/10 last:border-b-0 pb-4 last:pb-0"
                        >
                          <div className="flex items-start space-x-4">
                            ...
                            <div className="flex-1">
                              <h4 className="font-semibold text-hydro-onyx mb-1">
                                {office.name}
                              </h4>
                              <p className="text-sm text-hydro-onyx/70 mb-2">
                                {office.address}
                              </p>
                ...
                <Card className="border-hydro-green/20">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div>
                        <h4 className="font-medium text-hydro-onyx mb-1">
                          How quickly can you respond to inquiries?
                        </h4>
                        <p className="text-sm text-hydro-onyx/70">
                          We respond to all inquiries within 4 hours during
                          business hours.
                        </p>
                      </div>
                      <div>
                        ...
                        <p className="text-sm text-hydro-onyx/70">
                          Yes, we offer free 30-minute consultations for all
                          potential customers.
                        </p>
                      </div>
                      <div>
                        ...
                        <p className="text-sm text-hydro-onyx/70">
                          We service all of South Africa with partners in Cape
