// /app/api/product-by-id/route.ts
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    console.log('📦 Returning product:', result.name);
    return NextResponse.json(result); // Note: NOT wrapped in { product: result } like your slug endpoint
  } catch (error) {
